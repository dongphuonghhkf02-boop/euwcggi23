...
def test_manager_scope():
    ...
    if r.status_code == 200:
        ...
        if not scope.get("all"):
            print("   ✅ Manager scope is restricted (not 'all')")
        else:
            print("   ❌ Manager should not have 'all' scope")
...
def test_shipment_filters():
    ...
    if r.status_code == 200:
        ...
        if items:
            ...
            if all_delay_risk:
                print("   ✅ All items are delay_risk")
            else:
...
def test_carrier_creation():
    ...
    if r.status_code == 200:
        ...
        if r.status_code == 200:
            ...
            if found:
                print("   ✅ Test Carrier QA appears in carriers list")
            else:
                print("   ❌ Test Carrier QA not found in carriers list")
        ...
        if items:
            ...
            if r.status_code == 200:
                ...
                if bundle.get("shipment", {}).get("id") == shipment_id:
                    print("   ✅ Deal lookup returns correct shipment")
                else:
                    print("   ❌ Deal lookup returned wrong shipment")
                ...
                if docs:
                    ...
                    if r.status_code == 200:
                        ...
                        if not any(d.get("id") == doc_id for d in docs_after):
                            ...
                            print("   ❌ Document still present after deletion")
