...
def test_2_discovered_bridges_registered():
    ...
    if pre_c5e:
        ...
        print("✓ test_2_discovered_bridges_registered  "
              "(pre-C-5e: get_current_stage tier=C consumers=2, "
              "serialize_journey tier=C consumers=1)")
        return
...
def test_4_every_symbol_has_target_module():
    ...
    print("✓ test_4_every_symbol_has_target_module")
...
def test_8_tier_a_remains_empty():
    ...
    print("✓ test_8_tier_a_remains_empty  (Tier-A == frozenset())")
...
def test_9_retired_bridges_stay_retired():
    ...
    print("✓ test_9_retired_bridges_stay_retired  "
          "(db, sio, logger, bitmotors_parser_instance — all 0 prod imports)")
