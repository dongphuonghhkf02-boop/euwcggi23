...
def test_1_c4h_files_no_longer_import_db_from_server():
    ...
    assert not bad, (
        "[C-4h] FAIL: these files still import `db` from server:\n"
...
def test_5_c4h_inventory_flipped_to_migrated():
    ...
    print("✓ test_5_c4h_inventory_flipped_to_migrated  "
          "(4/4 module-service entries migrated=True)")
...
def test_6_prior_batches_remain_migrated():
    ...
    print("✓ test_6_prior_batches_remain_migrated  (C-4e=12, C-4f=4, C-4g=1)")
