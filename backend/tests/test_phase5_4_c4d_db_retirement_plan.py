...
def test_red_line_db_bridge_still_present():
    ...
    if db_bridge is None:
        ...
        print("✓ test_red_line_db_bridge_still_present  "
              "(C-4j post-retirement: db absent, Tier-A empty)")
        return
...
def test_no_class_c_workers_in_inventory():
    ...
    print("✓ test_no_class_c_workers_in_inventory  (zero Class-C)")
...
def test_no_repository_bridge_sites():
    ...
    print("✓ test_no_repository_bridge_sites  (repositories clean)")
...
def test_class_e_di_source_is_singleton_and_last():
    ...
    print("✓ test_class_e_di_source_is_singleton_and_last  "
          "(app/core/deps.py:get_db → C-4j)")
...
def test_db_runtime_module_absent_or_inert():
    ...
    if not db_rt_path.exists():
        print("✓ test_db_runtime_module_absent_or_inert  "
              "(module absent — C-4d-only state)")
        return
