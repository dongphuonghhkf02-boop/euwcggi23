...
def test_4_socket_runtime_module_shape_is_minimal():
    ...
    print("✓ test_4_socket_runtime_module_shape_is_minimal  "
          "(public surface: set_sio/get_sio/clear_sio_for_tests)")
...
def test_17_live_six_path_identity_match():
    ...
    assert "disconnect" in default_ns or any(
        ...
        "@sio.event disconnect handler not bound to canonical sio"
    )
