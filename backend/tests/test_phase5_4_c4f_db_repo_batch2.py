...
def test_1_c4f_routers_no_longer_import_db_from_server():
    ...
    assert not bad, (
        "[C-4f] FAIL: these files still import `db` from server:\n"
...
def test_5_c4f_inventory_flipped_to_migrated():
    ...
    print("✓ test_5_c4f_inventory_flipped_to_migrated  (4/4 _repo entries migrated=True)")
...
def test_9_repository_constructors_unchanged():
    ...
    print("✓ test_9_repository_constructors_unchanged  (4/4 repo classes intact)")
