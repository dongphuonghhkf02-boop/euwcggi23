...
class Wave2ABackendTester:
    ...
    def test_recording_proxy_not_found_or_502(self):
        ...
        if resp.status_code in (404, 502):
            ...
            self.log("Recording proxy returned 200 (unexpected but not a failure)", "warn")
            return True
        else:
    ...
    def test_matched_reasons_structure(self):
        ...
        self.log("All calls have properly structured matchedReasons[]", "info")
        return True
    ...
    def test_diagnostics_identifiers_structure(self):
        ...
        self.log("Identifiers section has all required keys", "info")
        return True
    ...
    def test_diagnostics_counts_structure(self):
        ...
        self.log("Counts section has all required keys and perKey breakdown", "info")
        return True
