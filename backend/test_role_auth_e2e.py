...
def test_team_lead_email_otp():
    ...
    with httpx.Client(timeout=TIMEOUT) as client:
        ...
        print("   ✓ team-lead JWT issued after OTP verify")
        ...
        print("   ✓ OTP cannot be reused (got 401 as expected)")
...
def test_admin_totp_full_flow():
    ...
    with httpx.Client(timeout=TIMEOUT) as client:
        ...
        print("   ✓ admin login now returns totp challenge")
        user_id = data["user_id"]
        ...
        print("   ✓ admin JWT issued after TOTP verify")
        ...
        print("   ✓ admin TOTP disabled (system left clean)")
...
def test_change_password_full_cycle():
    ...
    with httpx.Client(timeout=TIMEOUT) as client:
        ...
        print("   ✓ wrong current_password rejected (401)")
        ...
        print("   ✓ weak new password rejected (400 with detail)")
        ...
        print("   ✓ same-as-current rejected (400)")
        ...
        print("   ✓ manager password rotated successfully")
        ...
        print("   ✓ old password no longer works (401)")
        ...
        print("   ✓ rotated to clean temp password (seed restores on next startup)")
