...
async def main() -> int:
    ...
    try:
        async with httpx.AsyncClient(timeout=30.0) as http:
            ...
            print("  OK  container merged into same stage; no new stage created")
            ...
            print("  OK  MSC OSCAR → done; AQUARIUS → active")
            ...
            print("  OK  vessel_changed event logged")
            ...
            print("  OK  forced new stage; label should mention Algeciras")
