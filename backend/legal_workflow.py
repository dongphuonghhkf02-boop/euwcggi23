...
#: Each group exposes `labels: {en, ru}` for i18n; `label` keeps EN
#: as a backward-compatible default for legacy frontend code.
DEAL_STAGE_GROUPS: List[Dict[str, Any]] = [
    {"id": "lead",        "label": "Lead",        "labels": {"en": "Lead",        "ru": "Лид"},
     "stages": ["lead"]},
    {"id": "preparation", "label": "Preparation", "labels": {"en": "Preparation", "ru": "Подготовка"},
     "stages": ["qualified", "variants_sent"]},
    {"id": "deposit",     "label": "Deposit",     "labels": {"en": "Deposit",     "ru": "Депозит"},
     "stages": ["deposit_contract_drafted", "deposit_contract_signed", "deposit_paid"]},
    {"id": "search",      "label": "Search",      "labels": {"en": "Search",      "ru": "Поиск"},
     "stages": ["searching_at_auction", "auction_lost"]},
    {"id": "auction",     "label": "Auction",     "labels": {"en": "Auction",     "ru": "Аукцион"},
     "stages": ["auction_won"]},
    {"id": "payment",     "label": "Payment",     "labels": {"en": "Payment",     "ru": "Оплата"},
     "stages": ["final_contract_sent", "final_contract_signed", "after_win_payment_paid"]},
    {"id": "delivery",    "label": "Delivery",    "labels": {"en": "Delivery",    "ru": "Доставка"},
     "stages": ["in_transit_to_rotterdam", "arrived_rotterdam", "customs_calculated", "final_payment_paid", "in_transit_to_bg"]},
    {"id": "done",        "label": "Completed",   "labels": {"en": "Completed",   "ru": "Завершено"},
