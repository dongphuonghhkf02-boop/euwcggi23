...
PHASE_6_5_WAVE_2_RETIRED_BRIDGES: tuple[tuple[str, str, str], ...] = (
    ...
    *(
        (
            sym,
            "EXTRACTION_AUX_BRIDGES kind=CALC_ENGINE_DEP, tier=C-aux (registered by 5.5/B as one of the 43 calc-engine cluster bridges; consumed by app/services/calculator.py)",
