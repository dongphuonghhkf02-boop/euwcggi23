...
const TELEGRAM_BOT_USERNAME = process.env.REACT_APP_TELEGRAM_BOT_USERNAME || 'DmAutoCarsBot';
  ...
  return (
    <a
      ...
      className={`
        ...
        text-[var(--text-primary)] font-medium rounded-xl
...
export const TelegramConnectBanner = ({ 
  ...
  return (
    <div 
      className="bg-gradient-to-r from-[#0088cc] to-[#229ED9] text-[var(--text-primary)] rounded-2xl p-5 mb-6"
    ...
    >
      <div className="flex items-center gap-4">
        ...
        {onDismiss && (
          <button
            onClick={onDismiss}
            className="text-[var(--text-primary)]/70 hover:text-[var(--text-primary)] p-1"
            aria-label="Закрити"
          >
