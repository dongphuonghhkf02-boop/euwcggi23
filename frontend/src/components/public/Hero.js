...
const Hero = () => {
  ...
  return (
    <section className="relative bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 text-[var(--text-primary)] py-20 lg:py-32 overflow-hidden">
      {/* Background Pattern */}
            ...
            <div className="relative">
              <div className="flex bg-white rounded-xl overflow-hidden shadow-2xl">
                ...
                <button
                  ...
                  className="bg-zinc-900 hover:bg-zinc-800 disabled:bg-zinc-300 text-[var(--text-primary)] px-8 font-semibold flex items-center gap-2 transition-colors"
