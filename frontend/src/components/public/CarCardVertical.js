...
export const CarCardVertical = ({ v, idx = 0 }) => {
  ...
  return (
    <Link
      ...
      className="group bg-[var(--bg-elevated)] rounded-lg overflow-hidden flex flex-col transition-colors hover:bg-[#232321]"
      data-testid={`car-card-${idx}`}
    >
      {/* ---------- IMAGE ---------- */}
      <div className="relative aspect-[517/388] bg-[var(--bg-base)]">
        <img
        ...
        {countdown && (
          <div
            className="absolute top-3 left-3 h-8 flex items-center justify-center gap-2 px-3 bg-[var(--accent-brand)] text-black text-[14px] font-medium leading-none whitespace-nowrap select-none"
        ...
        <div className="absolute bottom-4 right-4 flex items-center gap-3">
          <button
            ...
            className="w-8 h-8 rounded-full border border-[var(--accent-brand)] flex items-center justify-center text-[var(--accent-brand)] bg-[var(--bg-base)]/20 hover:bg-[var(--accent-brand)] hover:text-black transition-colors"
            aria-label="Compare"
      ...
      <div className="px-6 pt-6 pb-4">
        <h3
          className="text-[var(--text-primary)] font-bold leading-tight"
          style={{ fontSize: 24 }}
      ...
      <div className="px-6 pb-4 grid grid-cols-[1fr_1fr] gap-4">
        ...
        <div className="bg-[var(--bg-base)] rounded-lg px-4 py-4 flex flex-col justify-between min-h-[120px]">
          <div className="text-[14px] text-[#EFEFEF] leading-snug">
            Estimated turnkey price (BY / RU)
          </div>
          <div
            className="text-[var(--accent-brand)] font-bold uppercase tracking-wide mt-2"
            style={{ fontSize: 20 }}
        ...
        <div className="flex flex-col justify-center gap-3 pl-1">
          <div className="flex items-center justify-between gap-3">
            <span className="text-[14px] text-[var(--text-primary)] capitalize">Mileage</span>
            <span
              className="text-[14px] font-bold uppercase text-[var(--accent-brand)] text-right"
          ...
          <div className="flex items-center justify-between gap-3">
            <span className="text-[14px] text-[var(--text-primary)] capitalize">Engine</span>
            <span className="text-[14px] font-bold uppercase text-[var(--accent-brand)] text-right whitespace-nowrap">
              {engine}
            </span>
          </div>
          <div className="flex items-center justify-between gap-3">
            <span className="text-[14px] text-[var(--text-primary)] capitalize">Drive</span>
            <span className="text-[14px] font-bold uppercase text-[var(--accent-brand)] text-right">
              {drive}
            </span>
          </div>
        </div>
      ...
      <div className="px-6 pb-6 pt-4 mt-auto flex items-end justify-between gap-4">
        <div>
          <div className="text-[14px] text-[#EFEFEF] mb-1">Average cost (BY / RU)</div>
          <div
            className="text-[14px] font-bold uppercase text-[var(--accent-brand)]"
        ...
        <span
          className="inline-flex items-center justify-center bg-[var(--accent-brand)] hover:bg-[var(--accent-brand-hover)] text-black text-[14px] font-medium rounded-md h-[45px] px-8 transition-colors"
