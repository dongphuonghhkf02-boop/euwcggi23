        ...
        <>
          ...
          <div className={styles.block}>
            ...
            <CustomDropdown
              ...
              options={[
                { label: 'mail.de',      value: 'maildede', available: true },
                { label: 'Mobile.de',    value: 'mobilede', available: true },
                { label: 'Autobid',      value: 'autobid',  available: true },
                { label: 'BCA',          value: 'bca',      available: true },
              ]}
                    ...
                    <span className={`${styles.checkbox} ${checked ? styles.checkboxOn : ''}`}>
                      {checked && (
                        <svg viewBox="0 0 16 16" width="12" height="12">
                          <path d="M3.5 8.5l3 3 6-6" fill="none" stroke="#162E51"
