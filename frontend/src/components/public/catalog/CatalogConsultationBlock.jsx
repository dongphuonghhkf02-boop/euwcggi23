...
const T = {
  ...
  ru: {
    titleYellow: 'НЕ ОТКЛАДЫВАЙТЕ ПОКУПКУ АВТОМОБИЛЯ',
    titleWhite:  'Бесплатная консультация',
    fullName:    'Полное имя',
    fullNamePh:  'Введите ваше полное имя',
    phone:       'Ваш номер телефона',
    desired:     'Желаемый автомобиль',
    desiredPh:   'Введите желаемый автомобиль',
    budget:      'Ваш бюджет',
    budgetPh:    'Введите ваш бюджет',
    wishes:      'Дополнительные пожелания',
    wishesPh:    'Добавьте дополнительные предпочтения',
    send:        'ОТПРАВИТЬ ЗАЯВКУ',
    sending:     'ОТПРАВКА…',
    haveQuestion:'Есть вопрос?',
    contactUs:   'Свяжитесь с нами',
    errName:     'Пожалуйста, введите ваше полное имя.',
    errPhone:    'Телефон должен начинаться с +359 и содержать 9 цифр.',
    errBudget:   'Пожалуйста, укажите ваш бюджет.',
    successTitle:'Заявка успешно отправлена',
    successText: 'Спасибо! Наш менеджер рассмотрит вашу заявку и свяжется с вами в ближайшее время, чтобы помочь подобрать идеальный автомобиль.',
    successBtn:  'Понятно',
  },
};
