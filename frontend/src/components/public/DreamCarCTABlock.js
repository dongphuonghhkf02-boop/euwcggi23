...
export default function DreamCarCTABlock() {
  return (
    <section className="bg-[var(--bg-base)] py-14" data-testid="dream-car-cta-section">
      <div className="max-w-[1920px] mx-auto px-6 lg:px-[100px]">
        <div className="relative rounded-md overflow-hidden" style={{ minHeight: 520 }}>
          ...
          {/* DM Auto marker top-left */}
          <div className="absolute top-8 left-8 flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-[var(--accent-brand)]" />
            <span className="text-[12px] uppercase tracking-[0.22em] text-[var(--accent-brand)] font-bold">
              DM Auto
            </span>
          </div>
          ...
          <div className="relative px-8 md:px-14 lg:px-20 py-16 md:py-24 min-h-[520px] flex items-center">
            <div className="w-full grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-12 items-end">
              ...
              <div>
                ...
                >
                  <span className="block text-[var(--accent-brand)]">Want to drive</span>
                  <span className="block text-[var(--text-primary)]">Your dream car?</span>
                </h2>
              </div>
              ...
              <div className="lg:pl-10">
                <p
                  className="text-[16px] md:text-[18px] text-[var(--text-primary)]/90 leading-snug mb-8"
                  style={{ maxWidth: 420 }}
                >
                  Fill out the application and we will find the best offer for you —
                  turnkey to Belarus / Russia, no hidden fees.
                </p>
                <Link
                  to="/contacts"
