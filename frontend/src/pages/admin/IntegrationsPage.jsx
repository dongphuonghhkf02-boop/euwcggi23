...
const PROVIDER_CONFIG = {
  ...
  stripe: {
    ...
    settings: [
      ...
      { key: 'statementDescriptor', label: 'Statement descriptor', type: 'text', placeholder: 'DM AUTO', help: 'Up to 22 characters shown on customer card statement.' },
      {
  ...
  resend: {
    ...
    fields: [
      ...
      { key: 'from',   label: 'From (verified sender)', type: 'text', placeholder: 'DM Auto <noreply@bibi.cars>' },
