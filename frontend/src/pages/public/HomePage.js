/**
 * HomePage — DM Auto main landing page (Figma reference parity).
 *
 ...
 *  12. FAQ                   → FAQBlock
 *
 * Header & footer come from DmAutoPublicLayout (one level up). This page only
 * renders the body sections.
 */
import React from 'react';

import DmAutoHero from '../../components/public/DmAutoHero';
...
export default function HomePage() {
  return (
    <div className="bg-[var(--bg-base)] text-[var(--text-primary)]" data-testid="home-page">
      {/* ─── 1. Hero ─────────────────────────────────────────────── */}
      <DmAutoHero />
