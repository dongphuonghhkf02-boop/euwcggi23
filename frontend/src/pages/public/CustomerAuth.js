          ...
          <div className="rounded-2xl bg-[var(--bg-elevated)] shadow-[0_20px_60px_rgba(0,0,0,0.55),inset_0_1px_0_rgba(255,255,255,0.04)] p-6 sm:p-8">
            ...
            <form onSubmit={handleEmailSubmit} className="space-y-4" data-testid="email-auth-form">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full h-[54px] mt-2 bg-[var(--accent-brand)] hover:bg-[var(--accent-brand-hover)] active:bg-[#0A1220] text-white rounded-md font-semibold text-[14px] tracking-[0.06em] uppercase transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        ...
        >
          ...
          >
            ...
            <button
              ...
              className="mt-5 w-full h-[50px] rounded-md bg-[var(--accent-brand)] hover:bg-[#1A2740] disabled:opacity-50 text-white text-[15px] font-bold tracking-wide transition-colors flex items-center justify-center gap-2"
            >
