    ...
    return (
      <div style={{ minHeight: '100vh', background: '#0F0F12', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
        <div style={{ maxWidth: 540, textAlign: 'center' }}>
          ...
          <Link to="/" style={{ color: '#F59E0B', textDecoration: 'underline' }}>← Back to DM Auto home</Link>
        </div>
      </div>
    );
  }
      ...
      <div style={{ maxWidth: 980, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 32, flexWrap: 'wrap', gap: 12 }}>
          <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: 12, textDecoration: 'none', color: 'inherit' }}>
            <div style={{ fontFamily: 'Mazzard H, sans-serif', fontWeight: 700, fontSize: 28, color: '#F59E0B' }}>DM Auto</div>
        ...
        {/* Breakdown table */}
        <div style={{ background: '#FFFFFF', borderRadius: 16, padding: 32, marginBottom: 24 }}>
        ...
        {comments.length > 0 && (
          <div style={{ background: '#FFFFFF', borderRadius: 16, padding: 24, marginBottom: 24 }}>
