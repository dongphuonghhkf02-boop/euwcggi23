            ...
            {types.map(t => (
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap transition-colors ${
                  activeType === t.key
                    ? 'bg-zinc-900 text-[var(--text-primary)]'
            ...
            {filtered.map(cluster => (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div className="w-12 h-12 bg-zinc-100 rounded-lg flex items-center justify-center group-hover:bg-zinc-900 group-hover:text-[var(--text-primary)] transition-colors">
                    <CarSimple size={24} />
                  </div>
      ...
      <div className="aspect-[4/3] relative bg-zinc-100">
        ...
        {vehicle.auctionDate && new Date(vehicle.auctionDate) > new Date() && (
          <div className="absolute bottom-3 right-3">
            <div className="bg-[var(--bg-base)]/70 text-[var(--text-primary)] text-xs px-2 py-1 rounded-lg flex items-center gap-1">
              <Timer size={12} />
