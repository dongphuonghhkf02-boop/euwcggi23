...
export default function VehiclesPage() {
  ...
  return (
    <div data-testid="catalog-page" className="text-[var(--text-primary)]">
      <section className="bg-[var(--bg-base)] pt-12 pb-20">
        <div className="max-w-[1920px] mx-auto px-6 md:px-10 lg:px-[60px] xl:px-[100px]">
          ...
          <div className="flex items-start justify-between gap-6 flex-wrap">
            ...
            <form
              ...
              className="flex items-center h-11 w-full md:w-[380px] xl:w-[420px] border border-[var(--accent-brand)]/50 rounded bg-[#0F0F0F] focus-within:border-[var(--accent-brand)] transition-colors"
              data-testid="catalog-search-form"
            >
              <button
                type="submit"
                aria-label="Search"
                className="ml-4 text-[var(--accent-brand)] hover:brightness-125 flex-shrink-0"
              ...
              <input
                ...
                className="flex-1 bg-transparent border-0 px-3 text-[13px] text-[var(--text-primary)] placeholder-[#6A6A6A] focus:outline-none min-w-0"
          ...
          <h1
            className="font-bold uppercase text-[var(--text-primary)] mt-10 leading-none"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] xl:grid-cols-[340px_1fr] gap-6 lg:gap-8 mt-12 items-start">
            ...
            <div className="min-w-0">
              ...
              <div className="flex items-center justify-between mb-6 lg:mb-8 flex-wrap gap-4">
                ...
                <button
                  type="button"
                  className="text-[13px] uppercase underline text-[var(--accent-brand)] hover:brightness-110 shrink-0"
              ...
              {loading && (
                <div className="text-[var(--text-muted)] py-20 text-center">Loading vehicles…</div>
              )}
              {!loading && items.length === 0 && (
                <div
                  className="text-[var(--text-muted)] py-20 text-center"
      ...
      <section className="bg-[var(--bg-base)] pb-20">
