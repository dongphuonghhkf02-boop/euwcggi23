/**
 * DM Auto — About Us page (V8) with EN/RU i18n.
 * Layout: DmAutoHeader + Hero + FrameOne + FrameTwo + ConsultationCTA + DmAutoFooter.
 */
...
const T = {
  en: {
    ...
    frame1Pre: 'Our company specializes in delivering cars from across Europe at ',
  ...
  ru: {
    ...
    aboutCrumb: 'О нас',
    title: 'О нас',
    tagline: 'Мы — ваш надёжный партнёр в мире автомобилей.',
    frame1Pre: 'Наша компания специализируется на доставке автомобилей из Европы по ',
    frame1Accent: 'лучшим ценам на рынке.',
    frame2Pre: 'Мы сочетаем конкурентные цены с ',
    frame2Accent: 'высоким уровнем сервиса',
    frame2Suf: ', чтобы вы получили не просто автомобиль, а уверенность в своём выборе.',
    frame2Body: 'Мы поможем найти идеальный вариант, который полностью соответствует вашим ожиданиям, образу жизни и бюджету.',
    ctaTitleYellow: 'Получите бесплатную профессиональную консультацию',
    ctaTitleWhite: 'по выбору автомобиля',
    fullName: 'Полное имя*',
    ...
    submitBusy: 'ОТПРАВКА…',
    submitDone: 'ОТПРАВЛЕНО ✓',
    okMsg: 'Спасибо! Мы свяжемся с вами в ближайшее время.',
    errName: 'Пожалуйста, введите ваше полное имя',
    errPhone: 'Введите корректный болгарский номер (например, 87 123 4567)',
    errSend: 'Не удалось отправить заявку, попробуйте ещё раз',
    quickCallTitle: 'Быстрый звонок в офис',
  },
};
    ...
    <section ref={secRef} className={`bibi-section bibi-frame-1 ${inView ? 'is-visible' : ''}`}>
      <div className="bibi-frame-1__canvas">
        <figure className="bibi-frame-1__photo--big reveal reveal--block-pop" style={{ animationDelay: '120ms' }}>
          <img src={`${ASSET}/IMG-0463-1-1@2x.png`} alt="DM Auto team with imported truck" loading="lazy" />
        </figure>
    ...
    <section ref={secRef} className={`bibi-section bibi-frame-2 ${inView ? 'is-visible' : ''}`}>
      <div className="bibi-frame-2__canvas">
        ...
        <figure className="bibi-frame-2__photo--small reveal reveal--block-pop" style={{ animationDelay: '180ms' }}>
          <img src={`${ASSET}/image-84-1@2x.png`} alt="DM Auto showroom" loading="lazy" />
        </figure>
        ...
        <figure className="bibi-frame-2__photo--big reveal reveal--block-pop" style={{ animationDelay: '320ms' }}>
          <img src={`${ASSET}/IMG-8461-1-1@2x.png`} alt="DM Auto team" loading="lazy" />
        </figure>
      </div>
    </section>
  );
