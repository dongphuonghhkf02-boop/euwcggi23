 ...
 */
const FrameComponent17 = ({ className = "", onProfileClick, onContactClick, isAuthed = false, customerName = "", variant = "full" }) => {
  ...
  // Variant gating — header1 now uses TWO instances of this component:
  //   • variant="utility" → only language + profile (lives in top utility bar)
  //   • variant="cta"     → only CONTACT US button (lives in main bar right)
  //   • variant="full"    → legacy behaviour (everything in one row)
  const showLangProfile = variant === "utility" || variant === "full";
  const showCta = variant === "cta" || variant === "full";

  return (
    <section className={[styles.languageSelectParent, className].join(" ")} data-variant={variant}>
      {showLangProfile && (
      <>
      ...
      <div className={styles.languageSelect} ref={triggerRef}>
        ...
        >
          ...
          <img
            ...
            sizes="100vw"
            alt=""
            src="/figma/lsicon-down-filled-dark.svg"
              ...
              <li key={l.code}>
                <button
                  ...
                  style={{
                    ...
                    textAlign: "left",
                    padding: "8px 12px",
                    background: active ? "#162E51" : "transparent",
                    color: active ? "#F5F0E8" : "#E7E7E7",
                    border: 0,
                    borderRadius: 4,
                    cursor: "pointer",
      ...
      >
        <img
          ...
          sizes="100vw"
          alt=""
          src={isAuthed ? "/figma/iconamoon-profile-authed.svg" : "/figma/iconamoon-profile-dark.svg"}
        />
      </div>
      </>
      )}
